...
<div class="wrapper">
    <div class="content">
        ...
        <div class="meta">
            ...
            <p class="meta-info">发表：<a href="/blog/index.php/Home/Cate/index/id/<?php echo ($arts["cateid"]); ?>"><?php echo ($catename); ?></a> &nbsp;&nbsp; 发表日期：<?php echo (date('Y-m-d',$arts["time"])); ?> &nbsp;&nbsp; </p>
        </div>
        ...
        <div class="entry">
            <p><img class="aligncenter size-full wp-image-42806"
                    src="/blog<?php echo ($arts["pic"]); ?>" alt="该去北上广哭，还是回小城市笑" width="630"
                    height="399"
    ...
    <div class="widget widget_recent_entries"><h3 class="widget-tit">最新发表</h3>
        <ul>
            <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="/blog/index.php/Home/Article/index/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
    </div>

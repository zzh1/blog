    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span
                    ...
                    class="crumb-step">&gt;</span><span>新增链接</span></div>
        </div>
                ...
                <form action="" method="post" id="myform" name="myform">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="url" name="url" size="50" value=""
                                       type="text">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <textarea name="desc" style="width:420px;heiht:100px;"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th></th>
